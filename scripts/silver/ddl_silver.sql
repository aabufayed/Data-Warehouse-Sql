-- =======================================
-- DDL Script: Create Silver Tables in MySQL
-- =======================================
-- Script Purpose:
-- This script creates tables in the 'silver' , dropping existing tables if they already exist.
-- It uses MySQL's syntax for handling table existence, default values, and data types.
-- =======================================
